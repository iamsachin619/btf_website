...
const About = () => {
  ...
  const servicesCards = [
                  {title:"Server Security",src:"https://www.devsnews.com/wp/torun/wp-content/uploads/2019/10/icon-3.png"},
                  {title:"Database Analysis",src:"https://www.devsnews.com/wp/torun/wp-content/uploads/2019/10/icon-2.png"},
                  {title:"Web Development",src:"https://www.devsnews.com/wp/torun/wp-content/uploads/2019/10/icon-01.jpg"},
                 ];
    ...
    const fetchData = async () => {
      ...
      for(let i = 1; i < 3; i++){
        ...
        console.log(comment.data.length,'comment')
         setBlogs((prevBlogs)=>[...prevBlogs, {...data.results[0],noOfComments:comment.data.length}])
      }
  ...
  return (
    ...
    >
      ...
      <Container maxWidth="lg">
      <Grid container spacing={8} style={{marginTop:"5%",display: "flex", alignItems: "center" }}>
      ...
      />
            ...
            <div style={{margin:"5%"}}></div>
              {/* <Typography style={{color:'black',fontSize:'16px',paddingBottom:15,fontWeight:'800'}}> */}
                <span style={{fontSize:"280%",fontWeight:"bolder"}}>More than 23+ years we provide
                <span style={{color:PrimaryColor}}> IT solutions </span> </span> <br/> <br/>
                <span style={{lineHeight:"26pt"}}>
                  Sed ut perspiciatis unde omnis iste natus errorsit voluptatem accusantium doloremque laudantium totam rem aperiam eaque ipsa quae ab illo invetore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem.
                <br/><br/>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem
                </span>
                <Button style={{marginTop:"5%",paddingLeft:"7%",paddingRight:"7%",paddingTop:"3%",paddingBottom:"3%",backgroundColor:PrimaryColor,color:"white"}} size="large" variant="outlined" endIcon={<ArrowRightAltIcon />}>
                  Learn More
                </Button>
            </Grid>
            </Grid>
     ...
     <Box
      ...
      <Container maxWidth="lg" >
      <Grid container align="left" spacing={4} style={{display: "flex", alignItems: "center" }}>
      ...
      <Grid container style={{display: "flex", alignItems: "center" }}>
            <Grid item xs={12} sm={12} md={6} align="left">
                <span style={{fontSize:"280%",fontWeight:"bolder",color:"white"}}>
                  Let’s Talk About Business Solutions With Us
                </span> 
            </Grid>
            <Grid item xs={6} sm={6} md={3}  align="right">
            <Button style={{backgroundColor:"white",color:"black",fontWeight:600,paddingLeft:"12%",paddingRight:"12%",paddingTop:"6%",paddingBottom:"6%"}} size="large" variant="outlined" endIcon={<ArrowRightAltIcon />}>
                  JOIN WITH US
                </Button>
            </Grid>
            <Grid item xs={6} sm={6} md={3}  align="center">
            <Button style={{color:"white",fontWeight:600,paddingLeft:"12%",paddingRight:"12%",paddingTop:"6%",paddingBottom:"6%"}} size="large" startIcon={<PhoneEnabledOutlinedIcon/>}>
            +812 (345) 789 88
                </Button>
            </Grid>
          </Grid>
     ...
     <Box
      ...
      <Container maxWidth="lg" >
        ...
        <Grid container maxWidth="lg" justifyContent="center" style={{marginTop:"3%"}}>
          <span style={{fontSize:"300%",fontWeight:600}}>Our Latest Case <br/> Studies  </span>     
        </Grid>
      <Grid container spacing={4} align="left" style={{marginTop:"5%",display:"flex",alignItems:"center"}}>
      {caseStudyCards.map( card => (
            <Grid item xs={12} sm={6} md={4}>
            
              <Card maxWidth="lg" style={{boxShadow:"none",borderRadius:0}}>
              {/* <CardContent> */}
              <Box
                component="img"
                src={card.src}
      ...
      <Container maxWidth="lg">
      <Grid container spacing={9} style={{display: "flex", alignItems: "center" }}>
            <Grid item xs={12} sm={6} md={6} align="left">
            {/* <Typography>  */}
            <DividerWithText>TESTIMONIALS</DividerWithText>
            <div style={{margin:"5%"}}></div>
                <span style={{fontSize:"300%",fontWeight:"bold"}}>What Our Client’s Say About us </span> <br/> <br/>
                <span style={{lineHeight:"26pt"}}>
                  {reviews !== null && reviews[index].review}
                  </span><br/>
                <div style={{marginTop:"5%"}}>
                <span style={{lineHeight:"16pt",fontSize:"180%",fontWeight:600}}>
                {reviews !== null && reviews[index].name} <br/> 
                  <span style={{fontSize:"60%",fontWeight:600,color:PrimaryColor}}>
    ...
    />
      ...
      >
        <Container maxWidth="lg">
          ...
          <Container maxWidth="lg">
      <Grid container spacing={9} style={{marginTop:"6%",marginBottom:"3%",display: "flex", alignItems: "center" }}>
            <Grid item xs={12} sm={12} md={5} align="left">
            <DividerWithText>OUR BLOG</DividerWithText>
            <div style={{margin:"5%"}}></div>
                <span style={{fontSize:"280%",fontWeight:"bold"}}>Read Our Latest
News & Blog </span>
               
            </Grid>
            
            <Grid item xs={12} sm={6} md={4} align="left">
            <Button style={{backgroundColor:PrimaryColor,color:"white",fontWeight:600,paddingLeft:"10%",paddingRight:"10%",paddingTop:"5%",paddingBottom:"5%"}} endIcon={<ArrowRightAltIcon />}>
                  VIEW ALL NEWS
                </Button>
            </Grid>
          </Grid>
      ...
      <Container maxWidth="lg">
      <Grid container  style={{marginBottom:"8%",display: "flex", alignItems: "center" ,justifyContent:'center'}}>
      ...
      />
            ...
            {blogs.map((blog)=>{
              return(
                ...
                <Card sx={{ display: 'flex', height: "30vh", marginTop:'10px'}}>
     ...
     />
     <Box sx={{ display: 'flex', flexDirection: 'column',marginLeft:"4%",paddingTop:"3%",paddingBottom:"2.5%" }}>
